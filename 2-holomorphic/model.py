"""Complex-valued MLP with the holomorphic exp(z) activation for the 2-holomorphic
benchmark."""
...
def init_model(
    ...
    *,
    ...
    component_std = lambda fan_in: jnp.sqrt(beta_array / (2.0 * fan_in * jnp.exp(beta_array)))
