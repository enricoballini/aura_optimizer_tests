"""Multi-seed comparison of complex optimizers on the 1-non_holomorphic benchmark."""
...
ADAM_CONFIG = optimizer_config.ADAM_CONFIG
NADAMW_CONFIG = optimizer_config.NADAMW_CONFIG
CVAMSGRAD_CONFIG = optimizer_config.CVAMSGRAD_CONFIG
AURA_CONFIG = optimizer_config.AURA_CONFIG
AURA_LIGHT_CONFIG = optimizer_config.AURA_LIGHT_CONFIG
MUON_CONFIG = optimizer_config.MUON_CONFIG
MUON_AURA_CONFIG = optimizer_config.MUON_AURA_CONFIG
MUON_AURA_S_CONFIG = optimizer_config.MUON_AURA_S_CONFIG
MUON_AURA_SIGN_CONFIG = optimizer_config.MUON_AURA_SIGN_CONFIG
MUON_AURA_SNR_CONFIG = optimizer_config.MUON_AURA_SNR_CONFIG
_sweep_beta_1 = os.environ.get("SWEEP_ADAM_BETA_1")
_sweep_beta_2 = os.environ.get("SWEEP_ADAM_BETA_2")
if _sweep_beta_1 is not None and _sweep_beta_2 is not None:
    _sweep_b1, _sweep_b2 = float(_sweep_beta_1), float(_sweep_beta_2)
    ADAM_CONFIG = replace(ADAM_CONFIG, beta_1=_sweep_b1, beta_2=_sweep_b2)
    NADAMW_CONFIG = replace(NADAMW_CONFIG, beta_1=_sweep_b1, beta_2=_sweep_b2)
    CVAMSGRAD_CONFIG = replace(CVAMSGRAD_CONFIG, beta_1=_sweep_b1, beta_2=_sweep_b2)
    AURA_CONFIG = replace(AURA_CONFIG, beta_1=_sweep_b1, beta_2=_sweep_b2)
    AURA_LIGHT_CONFIG = replace(AURA_LIGHT_CONFIG, beta_1=_sweep_b1)
    MUON_CONFIG = replace(MUON_CONFIG, beta_1=_sweep_b1, beta_2=_sweep_b2)
    MUON_AURA_CONFIG = replace(MUON_AURA_CONFIG, beta_1=_sweep_b1, beta_2=_sweep_b2)
    MUON_AURA_S_CONFIG = replace(MUON_AURA_S_CONFIG, beta_1=_sweep_b1, beta_2=_sweep_b2)
    MUON_AURA_SIGN_CONFIG = replace(MUON_AURA_SIGN_CONFIG, beta_1=_sweep_b1, beta_2=_sweep_b2)
    MUON_AURA_SNR_CONFIG = replace(MUON_AURA_SNR_CONFIG, beta_1=_sweep_b1, beta_2=_sweep_b2)
    optimizer_config.ADAM_CONFIG = ADAM_CONFIG
    optimizer_config.NADAMW_CONFIG = NADAMW_CONFIG
    optimizer_config.CVAMSGRAD_CONFIG = CVAMSGRAD_CONFIG
    optimizer_config.AURA_CONFIG = AURA_CONFIG
    optimizer_config.AURA_LIGHT_CONFIG = AURA_LIGHT_CONFIG
    optimizer_config.MUON_CONFIG = MUON_CONFIG
    optimizer_config.MUON_AURA_CONFIG = MUON_AURA_CONFIG
    optimizer_config.MUON_AURA_S_CONFIG = MUON_AURA_S_CONFIG
    optimizer_config.MUON_AURA_SIGN_CONFIG = MUON_AURA_SIGN_CONFIG
    optimizer_config.MUON_AURA_SNR_CONFIG = MUON_AURA_SNR_CONFIG
    # Only the subdirectory keeps grid points apart: key and config check ignore the betas.
    CACHE_DIR = CACHE_DIR / f"b1_{_sweep_b1:g}_b2_{_sweep_b2:g}"
...
def run_method(
    ...
    *,
    ...
    optimizer = optimizers.build_optimizer(
        ...
        nadamw_config=NADAMW_CONFIG,
        cvamsgrad_config=CVAMSGRAD_CONFIG,
        # Passed explicitly: build_optimizer's defaults are bound at import, before the override.
        aura_config=AURA_CONFIG,
        aura_light_config=AURA_LIGHT_CONFIG,
        muon_config=MUON_CONFIG,
        muon_aura_config=MUON_AURA_CONFIG,
        muon_aura_s_config=MUON_AURA_S_CONFIG,
        muon_aura_sign_config=MUON_AURA_SIGN_CONFIG,
        muon_aura_snr_config=MUON_AURA_SNR_CONFIG,
    )
