...
# on a 7.17 in text block, with the column titles and the epoch axis; the tuned row
# of 4-PINN-opt/plots.py is drawn below it and must keep the same size and y-range.
# Must match PINN_PAPER_LOSSES_NAME in update_paper_assets.py.
