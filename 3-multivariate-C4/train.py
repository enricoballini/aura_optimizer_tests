"""Multi-seed comparison of complex optimizers on the 3-multivariate_c4 benchmark."""
    ...
    summary = {
        "experiment": {
            **config.to_dict(),
            "seed": None,
            "seeds": seeds,
            "c4_domain_min": dataset.C4_DOMAIN_MIN,
            "c4_domain_max": dataset.C4_DOMAIN_MAX,
        },
        "software_and_device": {
            "jax": jax.__version__,
